        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0F172A] to-[#1E293B] flex flex-col">
            ...
            <div className="flex-1 max-w-7xl mx-auto w-full p-4 flex gap-4">
                ...
                >
                            ...
                            {messages.map((message, index) => (
                                ...
                                >
                                    <div className={`max-w-[80%] rounded-xl p-4 ${message.type === 'user'
                                        ...
                                        : 'bg-[#334155]/80 border border-[#475569]/30 text-gray-200 shadow-md'
                                        }`}>
                                        {message.content}
                                    </div>
                                </motion.div>
                    ...
                    {/* Action Buttons */}
                    <motion.div
                        className="border-t border-[#334155]/70 pt-4 space-y-2"
                        initial={{ y: 20, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
                    >
                        <motion.button
                            ...
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            className="w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800
                            disabled:from-[#334155] disabled:to-[#334155] disabled:opacity-70
