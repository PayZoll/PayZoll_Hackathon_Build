      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="w-full max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-center">
            <div className="space-y-6 relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left lg:col-span-7">
              ...
              <div className="flex flex-col sm:flex-row gap-5 pt-2 justify-center lg:justify-start">
                <button className="btn-primary flex items-center justify-center">
                  Get Started
                  <ArrowRight className="ml-2 h-5 w-5 text-purple-200" />
                </button>
            ...
            <div className="relative flex justify-center items-center lg:col-span-5 lg:-ml-12">
              ...
              <div className="relative w-full max-w-md h-auto animate-float">
                <Wallet2 className="w-full h-full text-purple-400" />
              </div>
            </div>
          </div>
        </div>
